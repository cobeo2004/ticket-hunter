...
export default function EventCard({ eventId }: { eventId: Id<"events"> }) {
  ...
  const imageUrl = useStorageUrl(event?.imageStorageId as Id<"_storage">);
        ...
        <div className="flex justify-between items-start">
          <div>
            <div className="flex flex-col items-start gap-2">
              {isEventOwner && (
                <span className="inline-flex items-center gap-1 bg-blue-600/90 text-white px-1.5 py-0.5 rounded-full text-xs font-medium">
